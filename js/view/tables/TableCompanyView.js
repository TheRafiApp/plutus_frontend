...
define([
  'app',
  'text!templates/tables/table-row-company.html',
],
function(app, TableRowTemplate) {
  ...
  return Backbone.View.extend(_.extend({}, Backbone.Events, {
    ...
    render: function() {
      ...
      this.$el.html(this.template({ company: data }))
      return this;
    },

    viewModel: function(e) {
      if (!$('.companies-table').hasClass('editing')) {
        $('.companies-table .row').removeClass('selected');
