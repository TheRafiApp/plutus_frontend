...
(function(factory) {
  ...
  _.extend(Model.prototype, Events, {
    ...
    save: function(key, val, options) {
      ...
      var method = options.patch ? 'patch' : (this.isNew() ? 'create' : 'update');
  ...
  // Hack in Backbone.Validation because I couldn't figure out how to make it
  // work with requireJS...
  //
  ...
  var defaultLabelFormatters = Validation.labelFormatters = {
    ...
    sentenceCase: function(attrName) {
      ...
      if (attrName.indexOf('[') > -1 && attrName.indexOf(']') > -1) {
        attrName = attrName.match(/\[\w*\]$/)[0].replace(/[\[\]]/g, '');
